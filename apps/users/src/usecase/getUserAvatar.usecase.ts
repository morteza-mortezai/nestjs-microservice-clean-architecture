...
export class GetUserAvatarUsecase {
    ...
    async getAvatar(userId: number) {
        ...
        // get avatr 
        // if (user && user.avatar) {
        // return this.externalApiService.downloadAndSaveFile(user.avatar)
        this.externalApiService.downloadAndSaveFile('https://reqres.in/img/faces/1-image.jpg', 'mmmm.jpg')
        // }
